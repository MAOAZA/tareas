######################################### Agenda de Contactos de 👑 MAOAZA_king ☯ Ejecutable en entorno grafico ########################################
import os
import sys
...
# Obtener la ruta donde está el ejecutable
...
shortcut_path = os.path.join(application_path, "contactos.lnk")

# Leer el destino del acceso directo
shell = win32com.client.Dispatch("WScript.Shell")
shortcut = shell.CreateShortCut(shortcut_path)
json_file_path = shortcut.TargetPath  # La ruta al archivo .json

# Ahora puedes acceder al archivo .json
print(f"Archivo de contactos encontrado en: {json_file_path}")
...
# Ruta directa al archivo contactos.json dentro de dist
json_file_path = os.path.join(application_path, "contactos.json")

# Usar json_file_path para abrir y leer el archivo .json
print(f"Archivo de contactos encontrado en: {json_file_path}")
